  ...
  return (
    <div className="px-6 py-10 max-w-4xl mx-auto  text-gray">
      ...
      <p className="mb-4 text-base leading-relaxed">
        At <strong>TechTinder</strong>, your privacy is our priority. This
      ...
      <p className="mb-4 text-base leading-relaxed">
        ...
        such as name, email, and tech skills. We also collect usage data to
      ...
      <p className="mb-4 text-base leading-relaxed">
        ...
        including encryption and secure data storage. No third-party shares
      ...
      <p className="mb-4 text-base leading-relaxed">
        We may integrate third-party services (like Razorpay) for features such
        as payments. These services have their own privacy policies which we
        encourage you to read.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-2">5. Your Rights</h2>
      <p className="mb-4 text-base leading-relaxed">
        You can access, edit, or delete your data anytime by visiting your
        profile settings. For any privacy-related concerns, email us at{" "}
        <a
          href="mailto:support@techtinder.live"
